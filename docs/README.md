...
适合场景：
- 想知道 `TaskView.vue` 当前拆分到了哪一步
- 想区分哪些块已拆、哪些块半拆、哪些块还没拆
- 想知道下一刀最适合先拆哪块，以及每一步该重点测什么
