export default {
  ...
  login: {
    ...
    changeSubtitle: 'First Sign In — Update Account',
    changeHint: 'For security, you must change your username and password on first login. Using "admin" as username is not allowed.',
