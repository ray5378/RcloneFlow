...
export const optionHelpMap: Record<string, string> = {
...
export function formatOptionKey(name: string) {
...
export function getOptionLabel(option: ProviderOption) {
  if (locale.value === 'zh') {
...
export function getOptionHelp(option: ProviderOption) {
  if (locale.value === 'zh') {
...
export function getOptionPlaceholder(option: ProviderOption) {
  if (locale.value === 'zh') {
...
export function getExampleHelp(help?: string) {
  if (!help) return ''
