...
.step { padding: 8px 12px; border-radius: 8px; background: #f3f4f6; color: #6b7280; font-size: 14px; }
...
.provider-card { padding: 14px; border: 1px solid #e5e7eb; border-radius: 12px; cursor: pointer; background: #fff; }
