...
describe('Task card action button hover colors', () => {
  it('uses semantic hover backgrounds for normal, info, and danger actions', () => {
    ...
    expect(actionStyles).toContain('.list-item-actions button.ghost.small.action-info:hover')
    expect(actionStyles).toContain('background: rgba(59, 130, 246, 0.18) !important')
    expect(actionStyles).toContain('.list-item-actions button.ghost.small.action-danger:hover')
    expect(actionStyles).toContain('background: rgba(239, 68, 68, 0.18) !important')
    ...
    expect(actionStyles).toContain('background: #dbeafe !important')
    expect(actionStyles).toContain('background: #fee2e2 !important')
  })
})
