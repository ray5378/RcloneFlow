...
<template>
  <div class="card">
    <div class="topbar">
      <div>
        <div style="font-size: 18px; font-weight: 600">任务管理</div>
        <div class="muted">创建复制 / 同步 / 移动任务</div>
      </div>
    </div>
  </div>
  ...
  <!-- Create Task -->
  <div class="card">
    <h3 style="margin: 0 0 16px">创建新任务</h3>
  ...
  <!-- Task List -->
  <div class="card">
    <h3 style="margin: 0 0 16px">任务列表</h3>
    <div class="list">
      <div v-for="task in tasks" :key="task.id" class="item">
        <div class="manage-row">
          ...
          <div class="actions" @click.stop>
            ...
            <div class="menu-area">
              <button class="menu-btn ghost small" @click="taskMenu = taskMenu === task.id ? '' : task.id">
                ⋮
              </button>
